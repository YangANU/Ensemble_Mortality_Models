...
## This R script contains functions for downloading and preparing age-specific mortality data for OECD countries.
## If using the CSV files in the provided "OECD_data" folder, skip this script and directly proceed to computations. 
...
# Write a function to download age-specific mortality rates from the Human Mortality Database
